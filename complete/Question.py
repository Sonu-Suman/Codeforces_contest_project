...
class Window:
    def __init__(self, root, credential):
        ...
        self.back_questions = Image.open(self.resource_path("images/back1.png"))
        self.search_questions = Image.open(self.resource_path("images/loupe.png"))
        self.setting_questions = Image.open(self.resource_path("images/setting1.png"))

        self.back_questions = ImageTk.PhotoImage(self.back_questions)
        self.search_questions = ImageTk.PhotoImage(self.search_questions)
        self.setting_questions = ImageTk.PhotoImage(self.setting_questions)

        self.back_button1 = Button(self.new_window, image=self.back_questions, bg='lemon chiffon', relief='flat',
                                            command=self.back_to_login)
        self.search_button2 = Button(self.new_window, image=self.search_questions, bg='lemon chiffon', relief='flat',
                                                    command=self.search_to_page)
        self.setting_button3 = Button(self.new_window, image=self.setting_questions, bg='lemon chiffon', relief='flat',
                                                    command=self.show_credential)

        self.back_button1.image = self.back_questions
        self.search_button2.image = self.search_questions
        self.setting_button3.image = self.setting_questions
