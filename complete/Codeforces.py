...
class Graphics:
    def __init__(self):
        ...
        self.logo = Image.open(self.resource_path("images/code.png"))
        self.logo2 = Image.open(self.resource_path("images/coding-language.png"))
        ...
        self.forward_logo = Image.open(self.resource_path("images/right-arrow.png"))
    ...
    def Signup_Confirmation(self):
        ...
        with open('permission.txt', 'r') as file:
            ...
            permission_txt.config(state=DISABLED)
