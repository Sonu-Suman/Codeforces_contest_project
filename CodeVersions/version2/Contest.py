...
class Window:
    def __init__(self, root):
        ...
        self.search_button2.grid(row=0, column=3, pady=10, padx=(5, 150), sticky=W)
        self.setting_button3.grid(row=0, column=4, pady=10, padx=(20, 10))


        self.select_four_search_combo = ttk.Combobox(self.new_window,
                                                      font=('arial', 12, 'bold'), width=8, height=30, state='readonly')
        self.select_four_search_combo['value'] = ('contest', 'question')
        self.select_four_search_combo.current(0)
        self.select_four_search_combo.grid(row=0, column=1, padx=(100, 0), sticky=E)
        self.select_four_search_combo.bind('<<ComboboxSelected>>', self.callback)


        self.entry = Entry(self.new_window, text='hello', font=('Times New Roman', 16, 'bold'), width=50)
        self.entry.grid(row=0, column=2, pady=10, sticky=W)
    ...
    def search_to_page(self):
        ...
        if self.data_structure:
            self.select_four_search_combo.current(0)
        elif self.Q_to_contest:
            self.select_four_search_combo.current(0)
            self.entry.delete(0, tk.END)

        if self.Q_to_contest:
