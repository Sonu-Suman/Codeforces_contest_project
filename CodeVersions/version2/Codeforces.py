...
from codeforceProject.CodeVersions.version2.Contest import Window
...
class Graphics:
    ...
    def __init__(self):
        ...
        self.algorithm_btn = RoundedButton(self.root, text="Algorithms \nQuestions", border_radius=30, font_size=20,
                                           fg='blue', color='hot pink', padx=10, pady=70, command=self.algorithm_page)
        ...
        self.question_btn = RoundedButton(self.root, text="Questions", border_radius=30, font_size=20, fg='blue',
                                          color='hot pink', padx=160, pady=70, command=self.question_page)
        self.question_btn.place(x=960, y=370)

        self.contest_btn = RoundedButton(self.root, text="Contest \nAll Questions", border_radius=30, font_size=20, fg='blue',
                                         color='hot pink', padx=5, pady=70, command=self.contest_page)
        self.contest_btn.place(x=960, y=500)
    ...
    def algorithm_page(self):
        if self.algorithm_to:
            Tree(self.root, true_false='algo')
        else:
            messagebox.showwarning("Invalid Access", "First you Log in!")

    def data_structure_page(self):
        if self.data_structure_to:
            Tree(self.root, true_false='data_structure')
        else:
            messagebox.showwarning("Invalid Access", "First you Log in!")
    ...
    def forgot_password(self):
        ...
        self.click_forgot_btn = RoundedButton(self.password_frame, text="Enter ", border_radius=4, font_size=18, fg='black', color='cornflower blue', padx=64, pady=24, command=self.access_password)
