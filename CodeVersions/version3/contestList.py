...
class ContestList:
    ...
    def __init__(self, root, credential):
        ...
        self.back_button1 = Button(self.selection_and_btn_frame, image=self.back, bg='lemon chiffon', relief='flat',
                                   command=self.back_to_login)
        self.back_button1.image = self.back
        self.back_button1.grid(row=1, column=0, pady=10, padx=(10, 10), sticky=W)
        ...
        self.setting_btn = Button(self.selection_and_btn_frame, image=self.setting, bg='lemon chiffon', relief='flat',
                                        command=self.show_credential)
        self.setting_btn.image = self.setting
        self.setting_btn.grid(row=1, column=4, padx=(0, 40), pady=10, sticky=E)
